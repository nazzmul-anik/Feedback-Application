  ...
  <div class="content_container container d-flex flex-column justify-content-center align-items-center">
    ...
    <form action="<%=application.getContextPath()%>/feedback" method="post" class="mt-3 text-white">
      ...
      <div class="mb-3">
        ...
        <input name="phone" type="text" class="form-control" id="phoneNumber" placeholder="Enter here">
      </div>
      <div class="mb-3">
        <label for="feedbackMessage" class="form-label">Your Feedback Message</label>
        <textarea name="message" rows="7" placeholder="Enter Here" class="form-control"></textarea>
      </div>
